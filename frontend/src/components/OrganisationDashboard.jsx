...
function ProfilePanel({ organisation, onSaved, canEdit }) {
  const [form, setForm] = useState(() => ({
    ...
    district: organisation.district || '', state: organisation.state || '', pincode: organisation.pincode || '', postOffice: organisation.postOffice || '',
    lat: organisation.lat ?? '', lng: organisation.lng ?? '', locationSource: '',
